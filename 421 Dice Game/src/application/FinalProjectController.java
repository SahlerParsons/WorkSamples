...
//	String currentPlayer = "Player1";
	...
	private void roll2(Dice player1, Dice player2) {
		...
		// turn should increment for both
		turn = turn + 1;
		...
		System.out.println(rollsTaken + " rollsTaken  Round changer ->" + roundChanger
				+ "  " + turn + "turn " + " round " + round + " player " + tfPlayerRoll.getText());
...
//		System.out.println(tgbtnDie1.isSelected());
		System.out.println(player1.getDie1() + " " +
				player1.getDie2() + " " +
				player1.getDie3() + " " + player2.getDie1() + " " +
				player2.getDie2() + " " +
				player2.getDie3());

		// limit second rollers turns to as many as first roller had
		if (turn == rollsTaken && roundChanger == 2) {
//			System.out.println("rollsTaken == turns");
			endTurn();
		}
		
		if (turn == 1) {             // if first roll set to 2nd
			tfRoll.setText("2");
		} else if (turn == 2) {      // if 2nd, to 3rd
			tfRoll.setText("3");
		} else if (turn == 3) {                     // if 3rd reset and take score
			endTurn();
		}
	...
	private void endTurn() {
		...
		if (roundChanger == 1) {
			...
			System.out.println("should not be here until 2nd player is done");
			String oldText = taScoreboard.getText();
...
//			tfPlayerRoll.setText(winner);
	...
	private void changeCurrentPlayerText() {
		System.out.println("should only be here after first roller ends turn");
		String currentPlayer = tfPlayerRoll.getText();
